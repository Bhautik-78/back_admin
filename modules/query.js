...
export const getAllSubDocuments = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const insertUpdateAllSubDocuments = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const getSingleSubDocument = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const deleteSingleDocument = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const insertSingleSubDocument = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const putSingleSubDocument = (model, subDocKey) => async (
  req,
  res,
  next
) => {
...
export const generateSubDocControllers = (
  model,
  subDocKey = "",
  overrides = {}
) => {
